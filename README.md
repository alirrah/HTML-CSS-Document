...
برای علامت کپی رایت از `&copy;` استفاده می کنیم.

برای اطلاعات بیشتر می توانید داخل نت سرچ کنید [html symbol](https://www.google.com/search?q=html+symbol)
...
برای عوض کردن عکس بالا تاپ بار مرورگر برای صفحه مان خظ زیر را داخل تگ head اضافه می کنیم.

```html
<link rel=”icon” type=”image-TYPE” href=”ADDRESS”>
```

(به جای ADDRESS آدرس عکس را بهش می دهیم.)
...
(به جای ADDRESS ادرس فایل css را می دهیم.)
...
با استفاده از :before و خصیصه content می شود متنی به قبل از یک تگ اضافه کرد.

با استفاده از :after و خصیصه content می شود متنی به بعد از یک تگ اضافه کرد.
...
(در متن بالا N عدد مدنظرمان است.)
...
[منبع برای یادگیری بیشتر](https://css-tricks.com/snippets/css/a-guide-to-flexbox/)
